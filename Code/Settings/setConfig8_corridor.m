function [obj] = setConfig8_corridor(obj)
...
% obj.mapHandle    = @generateMap16_closedCorridor; 
% obj.mapHandle    = @generateMap17_corridorJoined; %can be directly compared to map14
...
obj.stdPlanePlaneAngle    = deg2rad(0.05);
