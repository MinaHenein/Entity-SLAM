function [map] = generateMap10_longerStreet(config,camera)
...
%ground plane
pointPositions1  = [8*rand(1,nGPoints); 70*rand(1,nGPoints); 0*ones(1,nGPoints)] - [4 10 0]'*ones(1,nGPoints);
%building 1
pointPositions2  = [-4*ones(1,nB1XPoints); 35*rand(1,nB1XPoints); 10*rand(1,nB1XPoints)] - [0 0 0]'*ones(1,nB1XPoints);  %yz
pointPositions3  = [-8*rand(1,nB1YPoints); 0*ones(1,nB1YPoints);  10*rand(1,nB1YPoints)] - [4 0 0]'*ones(1,nB1YPoints);  %xz
pointPositions4  = [-8*rand(1,nB1ZPoints); 35*rand(1,nB1ZPoints); 10*ones(1,nB1YPoints)] - [4 0 0]'*ones(1,nB1ZPoints);  %xy
%building 2
pointPositions5  = [4*ones(1,nB2XPoints); 25*rand(1,nB2XPoints); 12*rand(1,nB2XPoints)] + [0 25 0]'*ones(1,nB2XPoints);  %yz
pointPositions6  = [8*rand(1,nB2YPoints); 0*ones(1,nB2YPoints);  12*rand(1,nB2YPoints)] + [4 25 0]'*ones(1,nB2YPoints);  %xz
pointPositions7  = [8*rand(1,nB2ZPoints); 20*rand(1,nB2ZPoints); 12*ones(1,nB2ZPoints)] + [4 25 0]'*ones(1,nB2ZPoints);  %xy
