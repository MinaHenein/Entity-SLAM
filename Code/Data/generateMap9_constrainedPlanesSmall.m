function [map] = generateMap9_constrainedPlanesSmall(config,camera)
...
%   1.3. Points
nPoints = 10;
pointPositions1  = [10*rand(1,nPoints/2); zeros(1,nPoints/2); 10*rand(1,nPoints/2)];                   %plane 1
pointPositions2  = [zeros(1,nPoints/2); 10*rand(2,nPoints/2)];    %plane 2
...
entityPoints = {[1:nPoints/2]',[nPoints/2 + 1:nPoints]'}';
entityChildEntities = {[]',[]'}';
