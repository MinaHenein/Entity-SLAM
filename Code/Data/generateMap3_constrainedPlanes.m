function [map] = generateMap3_constrainedPlanes(config,camera)
...
pointPositions1  = [10*rand(1,nPoints); zeros(1,nPoints); 10*rand(1,nPoints)]; %plane 1
pointPositions2  = [zeros(1,nPoints); 10*rand(2,nPoints)];    %plane 2
...
constraints(end+1,:) =  {[]',[]' ,[1 2]',[]','plane-plane-fixedAngle',0 ,0}; 
